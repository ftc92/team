...
class App extends Component {
  ...
  render() {
    ...
    let usrs=difference.map(function(u){
    ...
    return (
      <div className="container ">
        <h3>YOUR TEAM FOR THIS TEST<i class="fa fas fa-lg fa-users"></i></h3>

        <Team members={this.state.members} users={usrs} onAdd={this.handleClick} onDelete={this.handleDelete} />
      </div>
    );
  }
}
